              ...
              <div className="relative max-w-4xl mx-auto">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center mb-16 relative">
                    ...
                    >
                      {/* Shimmer Border Lightning - Only on Border */}
                      <motion.div
                        className="absolute inset-0 rounded-lg"
                        initial={{ opacity: 0 }}
                        animate={
                          educationInView ? { opacity: 1 } : { opacity: 0 }
                        }
                      ...
                      <div className="relative z-10">
                        <time className="font-mono italic text-white text-sm">
                          2023-2026
                        </time>
                  ...
                  <div className="flex items-center mb-16 relative">
                    ...
                    >
                      ...
                      {/* Content */}
                      <div className="relative z-10">
                        <time className="font-mono italic text-green-400 text-sm">
                          2021
                        </time>
                        <div className="text-lg font-black text-white mt-2">
