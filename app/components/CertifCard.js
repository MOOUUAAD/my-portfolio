...
const FeatureCard = ({
  ...
  return (
    <div className="relative flex flex-col items-center md:items-start p-7 w-[340px] rounded-[20px] bg-black shadow-lg transition-all duration-1000 overflow-hidden group hover-card">
