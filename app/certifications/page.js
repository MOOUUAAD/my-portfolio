...
const Certifications = () => {
  return (
    ...
    >
      <div class="flex flex-col md:flex-row justify-center items-center md:justify-start md:flex-wrap gap-8 md:mx-10 my-6">
        <FeatureCard
        ...
        />
        <FeatureCard
          logoImage="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/480px-Google_%22G%22_logo.svg.png"
